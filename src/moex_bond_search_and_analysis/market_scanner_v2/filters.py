...
def output_row(row: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        # Совместимость с контрактом V1 и последующими этапами pipeline.
        "Объем сделок с 15 дней, шт.": row.get("Объем за 15 дней, шт.", 0),
        ...
        "Нужна квалификация?": "ДА" if qualified_raw in {"1", "Y", "YES", "TRUE", "ДА"} else "НЕТ",
